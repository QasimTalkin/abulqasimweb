...
export const experiences: Experience[] = [
    {
        ...
        type: 'leadership',
        impact: [
            'Leading a cross-functional squad of 6 engineers (3 FE, 2 BE, 1 QA) in a Product-Design-Engineering triad, shipping core platform infrastructure and the flagship Memberships suite',
            'Owning quarterly and annual capacity planning with a lightweight estimation model that keeps delivery predictable across squads',
            'Driving an engineering-first review culture with architecture and code reviews, plus rapid PoCs that de-risk direction before Product commits',
            'Introducing an engineering onboarding playbook that ramps new hires quickly and consistently',
            'Coaching peer engineering leads new to management and steering org-wide structure in a Director-adjacent capacity',
            'Partnering with Marketing on Generative Engine Optimization (GEO), setting front-end readability standards for LLM discoverability, a first-mover play in Canadian fintech',
        ],
